...
from skill_chain.sensors.aux_nav_to_obj_sensors import AuxNavToObjSuccess
...
@registry.register_sensor
class AuxTargetStartSensor(UsesArticulatedAgentInterface, MultiObjSensor):
    """
...
@registry.register_measure
class AuxArtSuccessPos(Measure):
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxArtSuccessPos.cls_uuid
...
# class AuxMoveObjectsReward(MoveObjectsReward):
#     cls_uuid: str = "move_obj_reward"
    
#     @staticmethod
#     def _get_uuid(*args, **kwargs):
#         return AuxMoveObjectsReward.cls_uuid
...
"""
Aux Object Goal Sensor, using articulated agent interface 
"""
@registry.register_sensor
class AuxGoalSensor(UsesArticulatedAgentInterface, MultiObjSensor):
    """
...
@registry.register_sensor
class AuxMetaHierSkillSensor(Sensor):
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxMetaHierSkillSensor.cls_uuid
    ...
    def get_observation(self, observations, episode, *args, **kwargs):
        ...
        nav_to_obj_succ_cls = self._task.measurements.measures.get(AuxNavToObjSuccess.cls_uuid, None)
...
@registry.register_measure
class AuxTaskStageSteps(Measure):
    ...
    def _get_uuid(self, *args, **kwargs):
        return AuxTaskStageSteps.cls_uuid
...
@registry.register_sensor
class AuxHierSkillSensor(Sensor):
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxHierSkillSensor.cls_uuid
...
@registry.register_measure
class AuxDidPickCorrectObject(Measure):
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxDidPickCorrectObject.cls_uuid
...
@registry.register_measure
class AuxDidPickObjectMeasure(Measure):
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxDidPickObjectMeasure.cls_uuid
...
@registry.register_measure
class AuxDidPickMarkerMeasure(Measure):
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxDidPickMarkerMeasure.cls_uuid
...
@registry.register_measure
class AuxArtObjectAtDesiredState(Measure):
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxArtObjectAtDesiredState.cls_uuid
...
@registry.register_measure
class AuxEndEffectorDistToMarker(UsesArticulatedAgentInterface, Measure):
    """
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxEndEffectorDistToMarker.cls_uuid
...
@registry.register_measure
class AuxEndEffectorToGoalDistance(UsesArticulatedAgentInterface, Measure):
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxEndEffectorToGoalDistance.cls_uuid
...
@registry.register_measure
class AuxObjectToGoalDistance(Measure):
    """
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxObjectToGoalDistance.cls_uuid
...
@registry.register_measure
class AuxEndEffectorToObjectDistance(UsesArticulatedAgentInterface, Measure):
    """
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxEndEffectorToObjectDistance.cls_uuid
...
@registry.register_measure
class AuxRearrangePickSuccess(Measure):
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxRearrangePickSuccess.cls_uuid

    def reset_metric(self, *args, episode, task, observations, **kwargs):
        task.measurements.check_measure_dependencies(
            self.uuid, [AuxEndEffectorToObjectDistance.cls_uuid]
        )
...
class DidOpenArticulatedReceptacle(Measure):
    ...
    def reset_metric(self, task, *args, **kwargs):
        self._metric = False
        task.measurements.check_measure_dependencies(
            self.uuid, [AuxArtObjState.cls_uuid]
        )
        self.update_metric(task, *args, **kwargs)
    
    def update_metric(self, task, *args, episode, **kwargs):
        cur_js_state = task.measurements.measures[AuxArtObjState.cls_uuid].get_metric()
...
@registry.register_measure
class AuxRearrangePickReward(RearrangeReward):
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxRearrangePickReward.cls_uuid

    def reset_metric(self, *args, episode, task, observations, **kwargs):
        task.measurements.check_measure_dependencies(
            self.uuid,
            [
                AuxEndEffectorToObjectDistance.cls_uuid,
                RobotForce.cls_uuid,
...
@registry.register_measure
class AuxPddlStageGoals(Measure):
    _stage_succ: List[str]
    cls_uuid: str = "Aux_pddl_stage_goals"
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxPddlStageGoals.cls_uuid
    def reset_metric(self, *args, **kwargs):
        self._stage_succ = []
        self.update_metric(*args, **kwargs)
...
@registry.register_measure
class AuxArtObjReward(RearrangeReward):
    """
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxArtObjReward.cls_uuid

    def reset_metric(self, *args, episode, task, observations, **kwargs):
        task.measurements.check_measure_dependencies(
            self.uuid,
            [
                AuxArtObjState.cls_uuid,
                AuxArtObjSuccess.cls_uuid,
                EndEffectorToRestDistance.cls_uuid,
                AuxArtObjectAtDesiredState.cls_uuid,
            ],
        )
        ...
        dist_to_marker = task.measurements.measures[
            AuxEndEffectorDistToMarker.cls_uuid
        ].get_metric()
...
# Aux Articulated Object State # 
@registry.register_measure
class AuxArtObjState(Measure):
    """
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxArtObjState.cls_uuid
...
@registry.register_measure
class AuxArtObjSuccess(Measure):
    """
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxArtObjSuccess.cls_uuid
...
@registry.register_sensor
class AuxMarkerRelPosSensor(UsesArticulatedAgentInterface, Sensor):
    """
    ...
    @staticmethod
    def _get_uuid(*args, **kwargs):
        return AuxMarkerRelPosSensor.cls_uuid
