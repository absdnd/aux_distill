...
from skill_chain.tasks.aux_lang_pick_task import PddlMultiTask
...
@registry.register_task(name="AuxNavToObjTask-v0")
class AuxNavToObjTask(DynNavRLEnv):
...
@registry.register_task(name="AuxObjNavTask-v0")
class AuxObjectNavTask(PddlMultiTask):
