...
@registry.register_task(name="AuxRearrangePickTask-v0")
class AuxRearrangePickTaskV1(RearrangePickTaskV1):
...
@registry.register_task(name="AuxClosedCabinetRearrangePickTask-v0")
class AuxClosedCabinetPickTask(AuxRearrangePickTaskV1):
    def __init__(self, *args, config, dataset=None, **kwargs):
        super().__init__(
            config=config,
            *args,
...
@registry.register_task(name="AuxFridgeRearrangePickTask-v0")
class AuxFridgeRearrangePickTaskV1(AuxRearrangePickTaskV1):
    def __init__(self, *args, config, dataset=None, **kwargs):
        super().__init__(
            config=config,
            *args,
