...
@registry.register_task(name="MonoRearrangeOpenFridgeTask-v0")
class MonoRearrangeOpenFridgeTaskV1(RearrangeOpenFridgeTaskV1):
...
@registry.register_task(name="MonoNavRearrangeOpenFridgeTask-v0")
class MonoNavRearrangeOpenFridgeTaskV1(MonoRearrangeOpenFridgeTaskV1):
    def __init__(self, *args, config, dataset=None, **kwargs):
        super().__init__(
            config=config,
            *args,
...
@registry.register_task(name="MonoRearrangeOpenDrawerTask-v0")
class MonoRearrangeOpenDrawerTaskV1(SetArticulatedObjectTask):
    def __init__(self, *args, config, dataset=None, **kwargs):
        super().__init__(
            config=config,
            *args,
...
@registry.register_task(name="MonoNavRearrangeOpenDrawerTask-v0")
class MonoRearrangeNavOpenDrawerTaskV1(MonoRearrangeOpenDrawerTaskV1):
    def __init__(self, *args, config, dataset=None, **kwargs):
